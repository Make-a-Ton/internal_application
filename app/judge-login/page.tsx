...
import { User, ArrowUpRight, Settings, Eye, EyeOff, Shield } from "lucide-react";
...
export default function JudgeLoginPage() {
    ...
    const handleLogin = async () => {
        ...
        const result = await loginAsJudge(judgeName.trim(), enteredPin);
        if (result.success) {
            setTimeout(() => router.push("/judge"), 2500);
        } else {
                ...
                >
                    ...
                    <div className="text-center mb-10 relative">
                        ...
                        <motion.div
                            ...
                            className="w-16 h-16 bg-gold-light/10 rounded-2xl flex items-center justify-center mx-auto mb-4 border border-gold-dark/20"
                        >
