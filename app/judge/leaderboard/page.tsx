        ...
        <div className="min-h-screen p-8">
            ...
            {leaderboard.length === 0 ? (
                ...
                <div className="bg-[#7A2840]/30 rounded-2xl border border-[#7A2840] overflow-hidden">
                    {/* Table Header */}
                    <div className="grid grid-cols-4 gap-4 px-6 py-3 bg-[#5C0124] border-b border-[#7A2840] text-xs font-bold text-[#D4AF37] uppercase tracking-wider">
                        <span>Rank</span>
                        <span>Team</span>
                    ...
                    {leaderboard.map((entry, i) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className={`grid grid-cols-4 gap-4 px-6 py-4 border-b border-[#7A2840]/30 items-center hover:bg-[#7A2840]/30 transition-colors ${i < 3 ? "bg-[#D4AF37]/5" : ""}`}
                            >
